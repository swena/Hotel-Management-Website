...
require_once('recaptchalib.php');
  ...
  $sql="INSERT INTO hotel_customer VALUES(NULL,'$firstname','$lastname','$username','$password','$stu_date','$gender',$phone,$land,'$religion','$nationality',$postal,'$date','$city','$state','$country','$taddress','$paddress','$email',0,'')";
