...
<tr>
<td>Name:</td>
<td><input type="text" placeholder="FirstName" name="firstname" id="firstname"/><input type="text" placeholder="LastName" name="lastname" id="lastname"/></td>
</tr>
<tr>
<tr>
<td>Birthday</td>
...
<td>Landline No.</td>
<td><input type="text" maxlength="6" name="l1"/><input type="text" maxlength="10" name="l2"/></td>
</tr>
<tr>
...
<td><input type="text"  name="date1" id="datepicker1"/></td>
</tr>
<tr>
...
require_once('recaptchalib.php');
  ...
  $sql="INSERT INTO hotel_staff VALUES(NULL,'$firstname','$lastname','$username','$password','$stu_date','$gender','$qualification',$phone,'$email',$land,'$religion','$nationality',$postal,'$date','$city','$state','$country','$taddress','$paddress',1)";
