...
include 'include/customer_menu.php';
$id=$_SESSION['ID'];
$res = customer_detail($id);
...
<tr><td colspan="2"><a href="customer_home.php">Go Back</a></td></tr>
</table>
</form>
