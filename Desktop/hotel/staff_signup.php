...
require_once('recaptchalib.php');
  ...
  $sql="INSERT INTO hotel_staff VALUES(NULL,'$firstname','$lastname','$username','$password','$stu_date','$gender','$qualification',$phone,'$email',$land,'$religion','$nationality',$postal,'$date','$city','$state','$country','$taddress','$paddress',0,'')";
